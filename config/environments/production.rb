Rails.application.configure do
  config.action_mailer.default_url_options = { host: 'https://infinite-loops-chess.herokuapp.com/' }
  ...
  config.action_cable.url = "wss://infinite-loops-chess.herokuapp.com/cable"
